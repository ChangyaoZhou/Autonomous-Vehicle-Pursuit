...
def main():
    ...
    try:
        ...
        transform1 = world.get_map().get_spawn_points()[30] 
        ...
        camera_rgb2.listen(lambda image: image.save_to_disk('output/lidar_cdn/RGB1/%02d_%04d.png' % (FLAG, frame)))
        ...
        camera_rgb3.listen(lambda image: image.save_to_disk('output/lidar_cdn/RGB2/%02d_%04d.png' % (FLAG, frame)))
        ...
        lidar.listen(lambda image: image.save_to_disk('output/lidar_cdn/LIDAR/%02d_%04d.ply' % (FLAG, frame)))
    ...
    ##################### data collection ################################
        ...
        for frame in range(1000): 
            ...
            print('images/%02d_%04d.png' % (FLAG, frame), ref_i[-1][0], ref_i[-1][1], ref_i[-1][2], ref_i[-1][3], state_i[-1][0], state_i[-1][1], state_i[-1][2], state_i[-1][3], throttle, str_angle, file = f_data)
            f_data.close()
